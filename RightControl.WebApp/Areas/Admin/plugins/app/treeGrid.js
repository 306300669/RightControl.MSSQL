    ...
    var $ = layui.$
        ...
        ,TPL_HEADER = function(options){
            ...
            return ['<table cellspacing="0" cellpadding="0" border="0" class="layui-table" '
                ...
                ,'{{# } else if(item2.type === "checkbox_txt"){ }}'
                , '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose" {{# if(item2[d.data.checkName]){ }}checked{{# }; }}> {{item2.title}}'
                ,'{{# } else { }}'
                ...
                layui.each(data, function(i1, item1){
                    ...
                    that.eachCols(function(i3, item3){
                        ...
                        if (treeShowName == item3.field) {//当前是否用于显示的值
                            var _root = o.ParentId == 0 ? " root" : "";
                            treeImgHtml += '<div class="div-collapse' + _root + '">';
                            ...
                            if (item3.type === 'checkbox_txt') {
                                var _cbx = '<input type="checkbox" name="layTableCheckbox" tag="cbx_'+item1.Id+'" lay-skin="primary" ' + function () {
                                    ...
                                    if (item1.IsChecked) {
                                        return item1.IsChecked ? 'checked' : '';
                                    }
