...
namespace RightControl.WebApp.Areas.Admin.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(IUserService _userService, ILogService _logService,IRoleService _roleService)
        {
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                ...
                if (userEntity != null)
                {
                    ...
                    RoleModel roleModel = roleService.ReadModel(userEntity.RoleId);
                    if(roleModel!=null)
                    {//登陆用户的角色信息
                        operatorModel.Self = roleModel.Self;
                        operatorModel.Role_List = roleModel.Role_List;
                        operatorModel.RoleName = roleModel.RoleName;
                        operatorModel.RoleCode = roleModel.RoleCode;
                        operatorModel.RoleStatus = roleModel.Status;
                    }
